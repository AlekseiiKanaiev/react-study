...
export const APP_UPDATE_USER_MENU = 'APP/UPDATE_USER_MENU';
export const APP_UPDATE_USER_DISH = 'APP/UPDATE_USER_DISH';
export const APP_UPDATE_USER_SUCCESS = 'APP/UPDATE_USER_SUCCESS';
